...
from .views import  UsuarioPagoDetailAPIView, UsuarioPagoListCreateAPIView, RegisterView, AgendaUsuarioPagoListCreateAPIView, AgendaUsuarioPagoDetailAPIView 
...
urlpatterns = [
    ...
    path('agendausuariopago/<int:pk>/', AgendaUsuarioPagoDetailAPIView.as_view(), name='ageda-usuario-pago-detail'),
